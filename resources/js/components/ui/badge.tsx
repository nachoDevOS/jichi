...
/**
 * Los colores llegan desde los enums de PHP (EstadoTramite::color()), por eso
 * el mapa está escrito con clases completas: Tailwind necesita verlas literales
 * para incluirlas en el build.
 */
